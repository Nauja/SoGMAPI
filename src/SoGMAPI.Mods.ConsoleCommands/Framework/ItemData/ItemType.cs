namespace SoGModdingAPI.Mods.ConsoleCommands.Framework.ItemData
{
    /// <summary>An item type that can be searched and added to the player through the console.</summary>
    internal enum ItemType
    {
        /// <summary>A big craftable object in <see cref="SoG.Game1.bigCraftablesInformation"/></summary>
        BigCraftable,
        ...
        /// <summary>Any object in <see cref="SoG.Game1.objectInformation"/> (except rings).</summary>
        Object,
